...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int) {
	...
	kLocalVertices[0] = { 0.0f,20.0f,0.0f };
	kLocalVertices[1] = { 20.0f,-20.0f,0.0f };
	kLocalVertices[2] = { -20.0f,-20.0f,0.0f };
...
void VectorScreenPrintf(int x, int y, Vector3 vector) {
	for (int i = 0; i < 3; ++i) {
		...
		Novice::ScreenPrintf(x * kColumnWidth, y * kRowHeight, "%6.02f", vector.x);
		Novice::ScreenPrintf(x + 1 * kColumnWidth, y * kRowHeight, "%6.02f", vector.y);
		Novice::ScreenPrintf(x + 2 * kColumnWidth, y * kRowHeight, "%6.02f", vector.z);
